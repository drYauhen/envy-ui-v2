...
Generated contracts are derived from raw token JSON to provide literal unions and const arrays for component APIs.
...
- Output is written to `contracts/*.contract.ts` and is deterministic/idempotent.
...
3. Import generated types/consts from `contracts/<component>.contract.ts` in your component code.
