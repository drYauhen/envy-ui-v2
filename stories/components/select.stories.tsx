          ...
          <div style={formGroupStyle}>
            <label style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <span className="eui-label">
                {context === 'app' ? 'Interactive select' : 'Static select (print)'}
              </span>
              <select className="eui-select" disabled={context === 'report'}>
                <option value="">Choose an option</option>
                <option value="option1">Option 1</option>
                <option value="option2" selected={context === 'report'}>Option 2</option>
              </select>
            </label>
          </div>
        </div>
