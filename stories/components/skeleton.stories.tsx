    ...
    <div style={containerStyle}>
      <div style={sectionStyle}>
        ...
        <div style={sectionStyle}>
          ...
          <div className="eui-skeleton-group" data-eui-animation="wave" style={{ padding: '1.5rem', border: '1px solid #e5e7eb', borderRadius: '8px', maxWidth: '400px' }}>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ padding: '1.5rem', border: '1px solid #e5e7eb', borderRadius: '8px', maxWidth: '400px' }}>
            {/* Header with avatar and title */}
            <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
    ...
    <div style={containerStyle}>
      <div style={sectionStyle}>
        ...
        <div style={sectionStyle}>
          ...
          <div className="eui-skeleton-group" data-eui-animation="wave" style={{ display: 'flex', gap: '1rem', alignItems: 'center', padding: '1rem', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
            <div className="eui-skeleton" data-eui-variant="circular" style={{ width: '48px', height: '48px' }}></div>
            <div style={{ flex: 1 }}>
              <div className="eui-skeleton" data-eui-variant="text"></div>
              <div className="eui-skeleton" data-eui-variant="text" style={{ width: '70%', marginTop: '0.5rem' }}></div>
  ...
  render: () => (
    <div style={containerStyle}>
      <div style={sectionStyle}>
        ...
        <div className="eui-skeleton-group" data-eui-animation="wave" style={{ padding: '1.5rem', border: '1px solid #e5e7eb', borderRadius: '8px', maxWidth: '500px' }}>
          {/* Header */}
