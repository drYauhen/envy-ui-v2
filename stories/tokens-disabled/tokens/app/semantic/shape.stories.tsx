...
import shapeTokens from '../../../../tokens/contexts/app/semantics/shape.json';
import foundationShape from '../../../../tokens/contexts/app/semantics/shape.json';
...
const meta: Meta = {
  ...
  parameters: {
    ...
    ...getSectionParameters('Tokens/App/Semantic/Shape'),
    layout: 'fullscreen'
  }
};
