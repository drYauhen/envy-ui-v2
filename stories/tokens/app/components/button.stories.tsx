...
import semanticButton from '../../../tokens/app/components/button/colors.json';
import focusTokens from '../../../tokens/app/components/button/focus.json';
import sizeTokens from '../../../tokens/app/components/button/size.json';
import shapeTokens from '../../../tokens/app/components/button/shape.json';
import semanticBackground from '../../../tokens/app/semantic/colors/background.json';
import semanticFocus from '../../../tokens/app/semantic/colors/focus.json';
...
const meta: Meta = {
  title: 'Tokens/App/Components/Button',
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen'
  }
