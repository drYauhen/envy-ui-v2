...
import avatarColors from '../../../tokens/components/avatar/colors.json';
import avatarSize from '../../../tokens/components/avatar/size.json';
import avatarShape from '../../../tokens/components/avatar/shape.json';
import avatarBorder from '../../../tokens/components/avatar/border.json';
import avatarTypography from '../../../tokens/components/avatar/typography.json';
...
import foundationTextTransform from '../../../tokens/foundations/typography/text-transform.json';
...
const meta: Meta = {
  title: 'Tokens/Components/Avatar',
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen'
  }
