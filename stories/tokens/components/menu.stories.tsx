...
import menuColors from '../../../tokens/components/menu/colors.json';
import menuBorder from '../../../tokens/components/menu/border.json';
import menuShape from '../../../tokens/components/menu/shape.json';
import menuShadow from '../../../tokens/components/menu/shadow.json';
import menuSize from '../../../tokens/components/menu/size.json';
import menuSpacing from '../../../tokens/components/menu/spacing.json';
