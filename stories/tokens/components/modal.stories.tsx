...
import modalColors from '../../../tokens/components/modal/colors.json';
import modalShadow from '../../../tokens/components/modal/shadow.json';
import modalShape from '../../../tokens/components/modal/shape.json';
import modalSize from '../../../tokens/components/modal/size.json';
import modalSpacing from '../../../tokens/components/modal/spacing.json';
import modalBackdrop from '../../../tokens/components/modal/backdrop.json';
