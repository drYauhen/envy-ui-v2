...
export const adrs: DocMetadata[] = [
  ...
  {
    "number": "0042",
    "title": "Density Axis Defaulting and Inheritance",
    "category": "adr",
    "status": "Accepted (Partially Implemented)",
    "date": "2026-02-05",
    ...
    "owner": "Eugene Goncharov",
    "assistance": "AI-assisted drafting (human-reviewed)",
    "exportName": "densityAxisDefaultingandInheritance",
    "markdownPath": "/docs/adr/ADR-0042-density-axis-defaulting-and-inheritance.md",
    "storybookId": "docs-adr--density-axis-defaultingand-inheritance"
  },
  {
    "number": "0043",
