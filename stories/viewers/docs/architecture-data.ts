...
export const architectures: DocMetadata[] = [
  ...
  {
    "number": "002",
    "title": "Regulatory Baseline Audit 2026 04",
    "category": "architecture",
    "majorCategory": "ACCESSIBILITY",
    "status": "Active",
    "date": "2026-04-08",
    ...
    "owner": "Eugene Goncharov",
    "assistance": "AI-assisted drafting (human-reviewed)",
    "exportName": "ArchAccessibilityNum002RegulatoryBaselineAudit202604",
    "markdownPath": "/docs/architecture/ARCH-accessibility-002-regulatory-baseline-audit-2026-04.md",
    "storybookId": "docs-architecture--arch-accessibility-num-002-regulatory-baseline-audit-202604"
  },
  {
    "number": "001",
