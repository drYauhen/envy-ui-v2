...
Application context defines tokens for the application shell interface.

## Overview

The App context is optimized for application interfaces with:
- Desktop-first design approach
- High information density
- Standard application UI patterns
...
- Optimized for application interfaces
